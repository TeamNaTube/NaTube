...
object MyChannelPreferencesManager {
    ...
    lateinit var myChannelPreferences: SharedPreferences

    //Name of Shared Preference file
    private const val PREFERENCES_FILE_NAME = "My Channel Information"
    ...
    fun with(activity: AppCompatActivity) {
        myChannelPreferences = activity.getSharedPreferences(
    ...
    fun <T> remove(`object`: T, key: String) {
        ...
        val jsonString = GsonBuilder().create().toJson(`object`)
        //Save that String in SharedPreferences
        myChannelPreferences.edit().remove(key).apply()
    }
    ...
    inline fun <reified T> get(key: String): T? {
        ...
        val value = myChannelPreferences.getString(key, null)
    ...
    inline fun <reified T> getAll(): ArrayList<T?> {
        ...
        keys.forEach {
            val value = myChannelPreferences.getString(it, null)
